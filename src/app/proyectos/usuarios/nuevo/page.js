...
export default function CrearUsuarioPage() {
    ...
    const isAdmin = useMemo(() => user?.role === 'admin' || user?.role === 'administrador', [user]);
    ...
    const validate = async () => {
        ...
        if (Array.isArray(res.data) && res.data.length > 0) return 'El nombre de usuario ya existe.';
        return '';
    };
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            router.replace('/proyectos/usuarios');
        } catch {
